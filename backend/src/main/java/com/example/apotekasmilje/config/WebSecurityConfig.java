package com.example.apotekasmilje.config;

import com.example.apotekasmilje.security.TokenUtils;
import com.example.apotekasmilje.security.auth.RestAthenticationEntryPoint;
import com.example.apotekasmilje.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/blog/findByTitle").permitAll()
                .antMatchers("/answer/findAll").permitAll()
                .antMatchers("/question//findAll/{pageNo}/{pageSize}").permitAll()
                .antMatchers("/blog/findAllPubishedBlogsByType/{pageNo}/{pageSize}/{type}").permitAll()
